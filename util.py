...
class SQuAD(data.Dataset):
    ...
    def __init__(self, data_path, use_v2=True):
        ...
        # Select 5000 random records
        num_samples = 10000
        random_indices = indices[:num_samples]

        # Create a new dictionary with the selected records
        dataset = {
            'context_idxs': dataset['context_idxs'][random_indices],
            'context_char_idxs': dataset['context_char_idxs'][random_indices],
            'ques_idxs': dataset['ques_idxs'][random_indices],
            'ques_char_idxs': dataset['ques_char_idxs'][random_indices],
            'y1s': dataset['y1s'][random_indices],
            'y2s': dataset['y2s'][random_indices],
            'ids': dataset['ids'][random_indices]
        }
